const BridalGallery = () => {
    const images = import.meta.glob('/public/images/bridal/*.{jpg,jpeg,png,gif}', {
        eager: true,
        import: 'default',
    });
    ...
    return (
        <section className="page-content" style={{ padding: '4rem 0', backgroundColor: '#fff' }}>
            <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1rem' }}>
                <h1 style={{ fontSize: '2.5rem', marginBottom: '0.5rem' }}>Bridal Gallery</h1>
                <p style={{ color: '#b97b5c', fontSize: '1.1rem', marginBottom: '2rem' }}>
                    A collection of graceful and elegant bridal looks.
                </p>
